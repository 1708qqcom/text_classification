...
model.save_model(config.fasttext_model_path.replace(".bin", "_char_1.bin"))
print(f'保存模型到: {config.fasttext_model_path.replace(".bin", "_char_1.bin")}')
...
print("词向量大小:", len(model.get_word_vector("广")))
print("类别标签:", model.get_labels())
